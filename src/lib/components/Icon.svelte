<script lang="ts" module>
  /** Lightweight inline icon set (lucide-style, 24×24, stroke-based). */
  export const ICONS: Record<string, string> = {
    home: '<path d="M3 10.5 12 3l9 7.5"/><path d="M5 9.5V21h14V9.5"/>',
    setup: '<path d="M4 6h10"/><path d="M18 6h2"/><circle cx="16" cy="6" r="2"/><path d="M4 12h2"/><path d="M10 12h10"/><circle cx="8" cy="12" r="2"/><path d="M4 18h10"/><path d="M18 18h2"/><circle cx="16" cy="18" r="2"/>',
    robot: '<rect x="5" y="8" width="14" height="11" rx="2"/><path d="M12 8V4"/><circle cx="12" cy="3" r="1.4"/><path d="M9 13h.01"/><path d="M15 13h.01"/><path d="M2 13v3"/><path d="M22 13v3"/>',
    motion: '<path d="M13 2 4 14h7l-1 8 9-12h-7z"/>',
    admin: '<path d="M12 3 5 6v5c0 4.5 3 7.5 7 9 4-1.5 7-4.5 7-9V6z"/>',
    ...
    temp: '<path d="M12 4a2 2 0 0 1 2 2v7.5a4 4 0 1 1-4 0V6a2 2 0 0 1 2-2z"/>',
    ...
    cube: '<path d="M12 2 21 7v10l-9 5-9-5V7z"/><path d="m3 7 9 5 9-5"/><path d="M12 12v10"/>',
...
<script lang="ts">
  ...
  let { name, size = 18, stroke = 1.8, class: cls = "" }: Props = $props();
</script>
